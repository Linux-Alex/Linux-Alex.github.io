...
<head>
	...
	<meta name="author" content="Aleks Marinič">
	...
	<link rel="stylesheet" href="css/css-blogs.css">
	...
	<!--
		Background Gradient
	-->
	<link rel="stylesheet" href="css/css-gradient.css">
	...
	<!--
		Favicons
	-->
	<link rel="shortcut icon" href="favicons/favicons-favicon.ico">
...
<body>
      ...
      <li>
		...
		<div class="container opened" data-animation-in="fadeInLeft" data-animation-out="fadeOutLeft">
			...
			<header class="header">
				...
				<!-- header profile -->
				<div class="profile">
					<div class="title">Aleks Marinič</div>
					<div class="subtitle subtitle-typed">
						<div class="typing-title">
							<p>Spletni oblikovalec</p>
							<p>Razvijalec</p>
							<p>Programer</p>
						</div>
					</div>
					...
					<ul>
						<li class="active">
							<a href="#about-card">
								...
								<span class="link">O meni</span>
							</a>
						</li>
						<li>
							<a href="#resume-card">
								<span class="icon ion-android-list"></span>
								<span class="link">Šola</span>
							</a>
						</li>
						<li>
							<a href="#works-card">
								<span class="icon ion-paintbrush"></span>
								<span class="link">Projekti</span>
							</a>
						</li>
						<li>
							<a href="#blog-card">
			...
			<div class="card-started" id="home-card">
				...
				<div class="profile no-photo">
					...
					<!-- profile image -->
					<div class="slide" style="background-image: url(images/avatar.png); background-size: contain; background-position: bottom; background-position-y: 20px;"></div>
					...
					<!-- profile socials -->
					<div class="social">
						<a target="_blank" href="mailto:alex.marinic22@gmail.com"><span class="fa fa-envelope"></span></a>
						<a target="_blank" href="https://www.facebook.com/aleks.marinic/"><span class="fa fa-facebook"></span></a>
						<a target="_blank" href="https://github.com/Linux-Alex"><span class="fa fa-github"></span></a>
						<a target="_blank" href="https://www.snapchat.com/add/aleks_marinic"><span class="fa fa-snapchat"></span></a>
						<a target="_blank" href="https://join.skype.com/invite/MkDClpSQC0VR"><span class="fa fa-skype"></span></a>
					</div>

					<!-- profile buttons -->
					<div class="lnks">
						<a href="#" class="lnk">
							<span class="text">Prenesi živlejnepis</span>
						</a>
						<a href="#" class="lnk discover">
							<span class="text">Kontaktiraj me</span>
						</a>
					</div>
			...
			<div class="card-inner animated active" id="about-card">
				<div class="card-wrap">
					...
					<div class="content about">
						...
						<div class="row">
							<div class="col col-d-6 col-t-6 col-m-12 border-line-v">
								<div class="text-box">
									<p>
										Sem Aleks Marinič, študent Računalništva in informacijskih tehnologij na UM FERI.
										Imam končano srednjo šolo in pridobljeno izobrazbo tehnik računalništva.
					...
					<div class="content services">
						...
						<!-- title -->
						<div class="title">Ukvarjam se ...</div>
						...
						<div class="row service-items border-line-v">
							...
							<div class="col col-d-6 col-t-6 col-m-12 border-line-h">
								<div class="service-item">
									...
									<div class="desc">
										<div>
											<p>Izdelava naprednih spletnih mest z kompleksnimi aplikacijami po želji naročnikov.</p>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col col-d-6 col-t-6 col-m-12 border-line-h">
								<div class="service-item">
									...
									<div class="desc">
										<div>
											<p>Vsi izdelki so edinstveno oblikovani, da sovpadajo s sorodnimi programi/stranmi.</p>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col col-d-6 col-t-6 col-m-12 border-line-h">
								<div class="service-item">
									...
									<div class="desc">
										<div>
											<p>Programiram programske aplikacije za Linux in Windows z uporabo C++ in C# tehnologije.</p>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col col-d-6 col-t-6 col-m-12 border-line-h">
								<div class="service-item">
									...
									<div class="desc">
										<div>
											<p>Napredna vzpostavitev Linux in Windows strežnikov za posameznike ali podjetja.</p>
										</div>
									</div>
								</div>
							</div>
					...
					<!--
						Price Tables
					-->
					<div class="content pricing" hidden>
						...
						<div class="row pricing-items">
							...
							<div class="col col-d-6 col-t-6 col-m-12 border-line-v">
								<div class="pricing-item">
									...
									<div class="name">Enostavna fiksna spletna stran</div>
									<div class="amount">
					...
					<!--
						Clients
					-->
					<div class="content clients" hidden>
					...
					<!-- Quote -->
					<div class="content quote" hidden>
						...
						<div class="row">
							<div class="col col-d-12 col-t-12 col-m-12 border-line-v">
								<div class="revs-item">
									...
									<div class="user">
										<div class="img">
											<img src="images/images-profile.png" alt="Ryan Adlard">
										</div>
										<div class="info">
			...
			<div class="card-inner" id="resume-card">
				<div class="card-wrap">
					...
					<div class="content resume">
						...
						<!-- title -->
						<div class="title">Šola in dosežki</div>
						...
						<div class="row">
							...
							<div class="col col-d-6 col-t-6 col-m-12 border-line-v">
								<div class="resume-title border-line-h">
									...
									<div class="name">Priznanja</div>
								</div>
								<div class="resume-items">
									<div class="resume-item border-line-h">
										<div class="date">2020</div>
										<div class="name">Zlata matura</div>
										<div class="company">Srednja poklicna in tehniška šola</div>
										<p>Prejem priznanja zlatega maturanta.</p>
									</div>
									<div class="resume-item border-line-h">
										<div class="date">2018</div>
										<div class="name">Nemška jezikovna diploma</div>
										<div class="company">Deutschessprachdiplom</div>
										<p>Prejem nemške jezikovne diplome kategorije B1.</p>
									</div>
									<div class="resume-item">
										<div class="date">2009 - 2010</div>
										<div class="name">Nemško državno tekmovanje</div>
										<div class="company">srebrno priznanje</div>
										<p>Srebrno priznanje iz nemškega jezika na državnem tekmovanju.</p>
									</div>
								</div>
							</div>
							...
							<div class="col col-d-6 col-t-6 col-m-12 border-line-v">
								<div class="resume-title border-line-h">
									...
									<div class="name">Izobrazba</div>
								</div>
								<div class="resume-items">
									<div class="resume-item border-line-h active">
										<div class="date">2020 - sedanjost</div>
										<div class="name">Fakulteta za elektrotehniko, računalništvo in informatiko</div>
										<div class="company">univerza</div>
										<p>Pričetek VS študija, program Računalništvo in informacijske tehnologije.</p>
									</div>
									<div class="resume-item border-line-h">
										<div class="date">2016 - 2020</div>
										<div class="name">Srednja poklicna in tehniška šola Murska Sobota</div>
										<div class="company">srednja šola</div>
										<p>Naziv: tehnik računalništva<br>Dosežek: zlati maturant</p>
									</div>
									<div class="resume-item">
										<div class="date">2007 - 2016</div>
										<div class="name">Osnovna šola Sv. Jurij ob Ščavnici</div>
										<div class="company">osnovna šola</div>
										<p>Uspešno zaključena.</p>
									</div>
								</div>
							</div>
					...
					<div class="content skills">
						...
						<!-- title -->
						<div class="title">Moje veščine</div>
							...
							<div class="col col-d-6 col-t-6 col-m-12 border-line-v">
								<div class="skills-list">
									<div class="skill-title border-line-h">
										...
										<div class="name">Programiranje</div>
									</div>
									<ul>
										<li class="border-line-h">
											<div class="name">HTML, CSS, JS, PHP, SQL in Bootstrap</div>
											<div class="progress">
												<div class="percentage" style="width:90%;"></div>
											</div>
										</li>
										<li class="border-line-h">
											<div class="name">C# in .NET</div>
											<div class="progress">
												<div class="percentage" style="width:90%;"></div>
											</div>
										</li>
										<li class="border-line-h">
											<div class="name">C++, Qt in Arduino</div>
											<div class="progress">
												<div class="percentage" style="width:80%;"></div>
											</div>
										</li>
										<li class="border-line-h">
											<div class="name">BASH in Python</div>
											<div class="progress">
							...
							<div class="col col-d-6 col-t-6 col-m-12 border-line-v">
								<div class="skills-list dotted">
									<div class="skill-title border-line-h">
										...
										<div class="name">Jeziki</div>
									</div>
									<ul>
										<li class="border-line-h">
											<div class="name">Slovenščina</div>
											<div class="progress">
												<div class="percentage" style="width:100%;"></div>
											</div>
										</li>
										<li class="border-line-h">
											<div class="name">Nemščina</div>
											<div class="progress">
												<div class="percentage" style="width:80%;"></div>
											</div>
										</li>
										<li class="border-line-h">
											<div class="name">Angleščina</div>
											<div class="progress">
							...
							<div class="col col-d-6 col-t-6 col-m-12 border-line-v">
								<div class="skills-list circles">
									<div class="skill-title border-line-h">
										...
										<div class="name">Poznavanje IDE okolij</div>
									</div>
									<ul>
										<li>
											<div class="name">Visual Studio</div>
											<div class="progress p85">
												<span>85%</span>
											</div>
										</li>
										<li>
											<div class="name">Qt Creator</div>
											<div class="progress p75">
												<span>75%</span>
											</div>
										</li>
										<li>
											<div class="name">CLion</div>
											<div class="progress p70">
												<span>70%</span>
											</div>
										</li>
										<li>
											<div class="name">Monodevelop</div>
							...
							<div class="col col-d-6 col-t-6 col-m-12 border-line-v">
								<div class="skills-list list">
									<div class="skill-title border-line-h">
										...
										<div class="name">Iskušnje</div>
									</div>
									<ul>
										<li>
											<div class="name">Gostovanje spletne strani</div>
										</li>
										<li>
											<div class="name">Napredno oblikovanje spletnih mest</div>
										</li>
										<li>
											<div class="name">Izdelava napredne administracije</div>
										</li>
										<li>
											<div class="name">Izdelava logotipov</div>
										</li>
										<li>
											<div class="name">Oblikovanje za tisk</div>
										</li>
										<li>
											<div class="name">Optimizacija za mobilne naprave</div>
										</li>
										<li>
											<div class="name">Uporaba sistema oglaševanja</div>
										</li>
										<li>
											<div class="name">Uporaba minimalnih animacij</div>
										</li>
										<li>
											<div class="name">Reklamiranje strani</div>
										</li>
									</ul>
								</div>
							</div>
					...
					<!--
						Testimonials
					-->
					<div class="content testimonials" hidden>
									...
									<div class="owl-carousel">
										<div class="item">
											<div class="revs-item">
												...
												<div class="user">
													<div class="img"><img src="images/images-man1.jpg" alt=""></div>
													<div class="info">
			...
			<div class="card-inner" id="works-card">
				<div class="card-wrap">
					...
					<div class="content works">
						...
						<!-- title -->
						<div class="title">Dokončani projetki</div>

						<!-- filters -->
						<div class="filter-menu filter-button-group">
							<div class="f_btn active">
								<label><input type="radio" name="fl_radio" value="grid-item">Vsi</label>
							</div>
							<div class="f_btn">
								<label><input type="radio" name="fl_radio" value="website">Spletna mesta</label>
							</div>
							<div class="f_btn">
								<label><input type="radio" name="fl_radio" value="program">Programi</label>
							</div>
							<div class="f_btn">
								<label><input type="radio" name="fl_radio" value="other">Ostalo</label>
							</div>
						</div>
						...
						<div class="row grid-items border-line-v">
							...
							<!-- work item photo -->
							<div class="col col-d-6 col-t-6 col-m-12 grid-item website border-line-h">
								<div class="box-item">
									<div class="image">
									...
									<div class="desc">
										<a href="images/works/work1.jpg" class="name has-popup-image">Ubuntu Real Facts</a>
										<div class="category">spletno mesto</div>
									</div>
								</div>
							</div>
							...
							<div class="col col-d-6 col-t-6 col-m-12">
								<div class="box-item">
									...
									<div class="desc">
										...
										<div class="text">
											<p>Ex audire suavitate has, ei quodsi tacimates sapientem sed, pri zril ubique ut. Te cule tation munere noluisse. Enim torquatos&hellip;</p>
										</div>
									</div>
								</div>
							</div>
				...
				<aside id="secondary" class="widget-area">
					...
					<section class="widget widget_recent_comments">
						...
						<ul>
							...
							<li class="recentcomments">
								<span class="comment-author-link">admin</span> on <a href="#%22">Designing the perfect</a>
							</li>
							<li class="recentcomments">
	...
	<!--
		jQuery Scripts
	-->
	<script src="js/5940-js-jquery.min.js"></script>
	<script src="js/3814-js-jquery.validate.js"></script>
	<script src="js/2962-js-jquery.magnific-popup.js"></script>
	<script src="js/3842-js-imagesloaded.pkgd.js"></script>
	<script src="js/9002-js-isotope.pkgd.js"></script>
	<script src="js/736-js-jquery.slimscroll.js"></script>
	<script src="js/6707-js-owl.carousel.js"></script>
	<script src="js/1132-js-typed.js"></script>
	...
	<!--
		Main Scripts
	-->
	<script src="js/4846-js-scripts.js"></script>
